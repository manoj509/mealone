...
// import heroImage from "../assests/onlineservices.png"; // Update this path to match the background image location

// const Hero = () => {
//   return (
//     <div className="md:min-h-screen bg-gradient-to-r from-yellow-400 to-orange-500 flex flex-col items-center justify-center p-4 relative overflow-hidden">
...
//       {/* Logo Section */}
//       <div
//         className="flex flex-col items-center mb-6 z-10 animate-fade-in"
//         style={{ animationDelay: '0.5s' }}
//       >
//         <div className="bg-black rounded-full w-36 h-36 md:w-48 md:h-48 flex items-center justify-center shadow-lg animate-bounce-slow">
//           <img
//             src={logo}
//             alt="MealOne Logo"
...
//       <div
//         className="text-white text-center py-6 px-8 md:py-10 md:px-12 mt-4 max-w-sm md:max-w-md lg:max-w-xl bg-opacity-80 bg-cover z-10 animate-slide-up"
//         style={{
//           animationDelay: '1s',
